...
<div class="max-w-4xl mx-auto">
    <form action="/users/store" method="post" class="card bg-base-100 shadow-xl border border-base-200">
        <div class="card-body">
            <?= csrf_field() ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="form-control">
                    ...
                    <input type="text" name="name" class="input input-bordered focus:input-primary transition-all" placeholder="John Doe" required value="<?= old('name') ?>" />
                </div>
                ...
                <div class="form-control">
                    ...
                    <input type="email" name="email" class="input input-bordered focus:input-primary transition-all" placeholder="john@example.com" required value="<?= old('email') ?>" />
                </div>
                ...
                <div class="form-control">
                    ...
                    <input type="password" name="password" class="input input-bordered focus:input-primary transition-all" placeholder="••••••••" required />
                    <label class="label">
                        <span class="label-text-alt text-base-content/60">Min. 6 characters</span>
                    </label>
                </div>
                ...
                <div class="form-control">
                    ...
                    <div class="flex items-center gap-4 p-3 border rounded-lg hover:border-primary cursor-pointer transition-colors bg-base-200/30">
                        <input type="checkbox" name="is_active" class="toggle toggle-primary" checked value="1" />
